	...
	for percentageOfGraph in percentageOfGraphList:
		...
		for noOfTimesToRepeat in noOfTimesToRepeatList:
			...
			for i in range(10):
				...
				originalGraph,originalLabels,nodeAttributes = currentGraph,currentLabels,currentNodeAttributes

				mleParameters,indepModel_accuracy,indepModel_sqauredLoss = independentModel(originalLabels,nodeAttributes,trainingLabels)
				mpleParameters,mpleModel_accuracy,initialAccuracy,mpleModel_squaredLoss = MPLE(originalGraph,originalLabels,testLabels,nodeAttributes,mleParameters)
