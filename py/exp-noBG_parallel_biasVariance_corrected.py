	...
	for percentageOfGraph in percentageOfGraphList:
		...
		for noOfTimesToRepeat in noOfTimesToRepeatList:
				...
				for i in range(50):
					...
					print "learningBias:",learningBias
					print "totalBias:",totalBias
					print "learningVariance:",learningVariance
				...
				outputTofile.append( [ Action + "hoda_new_5.txt",prefix , str(trainingSize) , str(round(avgSquaredLoss,4)) , str(round(avgLearningBias,4)) , str(round(avgLearningVariance,4)) , str(round(avgTotalBias,4)) , str(round(avgTotalVariance,4)) , str(round(avgInferenceBias,4)) , str(round(avgInferenceVariance,4)) ])
