...
def ComputeLabelAttrCorrelation(labels, attrs, ind=0):
	...
	mean2 = 0.0
	total = 0.0
	for vertex,neighbors in labels.iteritems():
		mean1 += labels[vertex]
...
def CreateAGMSamples(size, verbose_check=True, show_dd=False):
	...
	pa = PreferentialAttachment(200, 5, 5)
